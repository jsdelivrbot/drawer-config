			...
			link: function(scope, element, attrs, ngModel){
				...
				if(attrs.ngModel){
					...
					ngModel.$render = function(){
						...
						// if the editors arent focused they need to be updated, otherwise they are doing the updating
	...
	return {
		...
		registerEditor: function(name, scope, targetToolbars){
			...
			editors[name] = {
				...
				// this is a suite of functions the editor should use to update all its linked toolbars
				editorFunctions: {
					disable: function(){
